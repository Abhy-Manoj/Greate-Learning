...
function Checkfirstname() {
    ...
    if (fnamevalue.value.trim() == "") {
        ...
        setErrorFor(fnamevalue, 'Name cannot contain numbers or special characters');
    } else {
...
function CheckEmail() {
    ...
    if (emailValue.value.trim() == "") {
        setErrorFor(emailValue, "Email required");
    } else if (!isEmail.test(emailValue.value.trim())) {
        setErrorFor(emailValue, 'Invalid email address');
    } else {
...
function CheckPhoneNumber() {
    var isPhoneNumber = /^\d{10}$/;
    let phoneNumberInput = document.getElementById("Phone");
    let phoneNumberValue = phoneNumberInput.value.trim();

    if (phoneNumberValue === "") {
        setErrorFor(phoneNumberInput, "Phone number required");
    } else if (!isPhoneNumber.test(phoneNumberValue)) {
        setErrorFor(phoneNumberInput, "Phone number should contain 10 digits only!");
    } else {
...
function CheckState() {
    ...
    if (stateValue.value.trim() == "") {
        setErrorFor(stateValue, "State required");
    } else if (/^\d/.test(stateValue.value.trim())) {
        setErrorFor(stateValue, "Invalid State Details");
    } else {
...
function CheckCity() {
    ...
    if (CityValue.value.trim() == "") {
        setErrorFor(CityValue, "City required");
    } else if (/^\d/.test(CityValue.value.trim())) {
        setErrorFor(CityValue, "Invalid City Details");
    } else {
...
function CheckUsername() {
    ...
    if (usernamevalue.value.trim() == "") {
        setErrorFor(usernamevalue, "Username is required");
    }
    else if (!isName.test(usernamevalue.value.trim())) {
        setErrorFor(usernamevalue, 'Not a valid username');
    }
    else {
...
function CheckPassword() {
    var isPassword = /^(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,15}$/;
    let passwordValue = document.getElementById("Password");
    if (passwordValue.value.trim() == "") {
        setErrorFor(passwordValue, "Password is required");
    } else if (!isPassword.test(passwordValue.value.trim())) {
        setErrorFor(passwordValue, "Password must be 8-15 characters long, contain at least one digit, one lowercase letter, and one uppercase letter");
    } else {
...
function CheckConfirmPassword() {
    ...
    if (confirmPasswordValue.value.trim() == "") {
        setErrorFor(confirmPasswordValue, "Confirm password is required");
